...
public class SimpWifip2pBroadCastReceiver extends BroadcastReceiver{

    private FoodISTActivity mActivity;

    public SimpWifip2pBroadCastReceiver(FoodISTActivity activity) {
        super();
